...
const LoadingScreen = ({ onComplete }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#0a0a0f] text-white overflow-hidden"
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <motion.div 
          ...
          className="w-[500px] h-[500px] bg-fuchsia-500/20 rounded-full blur-[120px]"
        />
      </div>
      ...
      >
        ...
        <motion.div
          ...
          className="relative text-3xl md:text-5xl font-black tracking-widest mb-10"
        >
